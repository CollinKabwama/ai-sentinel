...
/**
 * Identity-centric view for a single request, carried in {@link dev.aisentinel.core.model.RequestContext}.
 * <ul>
 *   <li><strong>Feature off</strong> — {@link dev.aisentinel.core.identity.spi.NoopIdentityContextResolver}: key absent.</li>
