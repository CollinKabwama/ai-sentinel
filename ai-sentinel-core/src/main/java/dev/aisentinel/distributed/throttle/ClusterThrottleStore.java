 ...
 * (see {@link dev.aisentinel.core.enforcement.CompositeEnforcementHandler#tryAcquireThrottlePermit}).
 * <p>
...
public interface ClusterThrottleStore {
     ...
     * @param enforcementKey identity hash or identity|endpoint per {@link dev.aisentinel.core.enforcement.EnforcementScope}
