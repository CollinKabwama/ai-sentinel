...
public interface ClusterQuarantineReader {
     ...
     * @param enforcementKey same key shape as {@link dev.aisentinel.core.enforcement.CompositeEnforcementHandler}
     *        uses internally (identity or identity|endpoint per {@link dev.aisentinel.core.enforcement.EnforcementScope})
