...
- Current maturity boundary:
  - dataset/export, reference dataset, deterministic replay, and foundational detection-evaluation alignment are in place
  - next work is detection metrics, the official detection baseline, and candidate-model/pilot rails
...
| Detection evaluation | Detection evaluation framework | ◐ PARTIAL | Add metric computation, temporal analysis, and reusable reports on top of aligned observations |
