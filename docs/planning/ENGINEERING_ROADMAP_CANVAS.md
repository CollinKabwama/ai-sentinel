...
- Current maturity boundary:
  - core runtime and benchmark foundations are in place
  - next work is dataset/export, replay, detection evaluation, and candidate-model/pilot rails
...
| 7 | Reference synthetic / evaluation dataset | → NEXT | Create tracked data that conforms to the export contract |
| 8 | Deterministic replay platform | ○ PLANNED | Replay the reference dataset through controlled scorer/config paths |
...
5. Scorer plug-in / candidate-model integration hardening
6. Shadow scoring
7. Remaining deployment/degradation evidence
8. Model lifecycle and champion/challenger
