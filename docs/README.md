...
| [`contracts/`](contracts/FEATURE_SCHEMA.md) | Versioned feature-schema, evaluation-event, dataset-export, [scorer/model artifact](contracts/SCORER_ARTIFACT.md), and [candidate loading/health](contracts/SCORER_CANDIDATE_LOADING.md) contract documentation |
