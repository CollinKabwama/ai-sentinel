...
| [`contracts/`](contracts/FEATURE_SCHEMA.md) | Versioned feature-schema, evaluation-event, dataset-export, and [scorer/model artifact](contracts/SCORER_ARTIFACT.md) contract documentation |
