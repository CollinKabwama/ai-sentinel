...
| [`../evaluation/`](../evaluation/DETECTION_EVALUATION.md) | Offline Detection Evaluation Framework plus [Official Detection Reference Baseline](../evaluation/DETECTION_REFERENCE_BASELINE.md) capture, verification/drift, and lifecycle/governance tooling (not production efficacy / not a quality gate). |
