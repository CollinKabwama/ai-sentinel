...
- **Public API compatibility gate** — Maven profile `api-compatibility` runs japicmp for published modules against the configured Central baseline (default **0.2.0** for this release candidate validation).
