...
import dev.aisentinel.autoconfigure.actuator.SentinelActuatorEndpoint;
...
class DistributedQuarantineValidationTest {
    ...
    void writerBeanIsRedisImplementationInSharedRedisContext() {
        assertThat(clusterQuarantineWriter).isInstanceOf(
            dev.aisentinel.autoconfigure.distributed.quarantine.RedisClusterQuarantineWriter.class);
    }
