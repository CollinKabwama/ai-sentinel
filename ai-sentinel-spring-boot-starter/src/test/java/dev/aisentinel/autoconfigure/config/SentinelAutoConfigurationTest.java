...
import dev.aisentinel.autoconfigure.identity.ServletIdentityContextResolver;
import dev.aisentinel.autoconfigure.identity.trust.RedisFailOpenBehavioralBaselineStore;
import dev.aisentinel.autoconfigure.distributed.DistributedQuarantineAutoConfiguration;
import dev.aisentinel.autoconfigure.model.ModelRefreshScheduler;
import dev.aisentinel.autoconfigure.model.ModelRegistryAutoConfiguration;
import dev.aisentinel.autoconfigure.distributed.DistributedQuarantineStatusAutoConfiguration;
import dev.aisentinel.autoconfigure.distributed.DistributedThrottleStatusAutoConfiguration;
...
class SentinelAutoConfigurationTest {
    ...
    void autoConfigurationCreatesSentinelBeansWhenEnabled() {
        contextRunner
            ...
            .run(context -> {
                assertThat(context).hasSingleBean(dev.aisentinel.core.SentinelPipeline.class);
