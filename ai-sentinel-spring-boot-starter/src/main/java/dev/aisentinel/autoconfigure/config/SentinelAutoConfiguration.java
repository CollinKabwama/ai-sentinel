...
import dev.aisentinel.autoconfigure.distributed.OnDistributedQuarantineStatusNeededCondition;
import dev.aisentinel.autoconfigure.distributed.DistributedThrottleStatus;
import dev.aisentinel.autoconfigure.distributed.OnDistributedClusterThrottleEnabledCondition;
...
import dev.aisentinel.core.policy.DefaultTrustPolicyAdjuster;
...
import dev.aisentinel.core.policy.TrustPolicyConfig;
...
import dev.aisentinel.core.telemetry.TelemetryConfig;
import dev.aisentinel.core.telemetry.TelemetryEmitter;
import dev.aisentinel.autoconfigure.distributed.training.AsyncTrainingCandidatePublisher;
import dev.aisentinel.autoconfigure.distributed.training.LoggingTrainingCandidateTransport;
 ...
 * ({@link dev.aisentinel.core.feature.FeatureExtractor}, {@link dev.aisentinel.core.policy.PolicyEngine}, etc.).
 * <p>
 * Model registry refresh is registered separately in {@link dev.aisentinel.autoconfigure.model.ModelRegistryAutoConfiguration}.
 */
@Slf4j
@AutoConfiguration
