...
/**
 * Mutable snapshot for actuator / ops (read path: {@link dev.aisentinel.autoconfigure.distributed.quarantine.RedisClusterQuarantineReader};
 * write path: {@link dev.aisentinel.autoconfigure.distributed.quarantine.RedisClusterQuarantineWriter}).
 */
