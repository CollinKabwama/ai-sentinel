 ...
 *       {@code tenantId} argument to {@link dev.aisentinel.distributed.quarantine.ClusterQuarantineReader})</li>
 *   <li>{@code enforcementKey} — same shape as local enforcement:
 *       identity hash, or {@code identity|endpoint} per {@link dev.aisentinel.core.enforcement.EnforcementScope}</li>
 * </ul>
